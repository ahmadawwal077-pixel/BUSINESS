...
const CourseDetail = () => {
  ...
  const fetchCourse = async () => {
    try {
      ...
      const isEnrolled = enrolledCoursesRes.data.some(e => e.course._id === id);
  ...
  if (loading) {
    return (
      <div style={{
        ...
        <div style={{ fontSize: '1.5rem', color: '#0066cc' }}>Loading course details...</div>
      </div>
    );
  }
  ...
  if (!course) {
    return (
      <div style={{
        ...
        <div style={{ fontSize: '1.5rem', color: '#dc2626' }}>Course not found</div>
      </div>
    );
  }
        ...
        <div style={{
          ...
          <div style={{
            ...
            <div style={{
              ...
              <div>
                ...
                <p style={{
                  ...
                  {Math.max(0, course.maxStudents - course.enrolledStudents)}/{course.maxStudents}
                </p>
              </div>
            </div>
            ...
            <div style={{
              ...
              >
                {enrolled ? '✓ Already Enrolled' : (course.enrolledStudents >= course.maxStudents ? 'Course Full' : (enrolling ? 'Processing...' : 'Enroll Now'))}
              </button>
            </div>
          </div>
        </div>
