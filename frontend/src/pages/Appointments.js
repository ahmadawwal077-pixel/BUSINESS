...
const Appointments = () => {
  ...
  const getStatusColor = (status) => {
    const colors = {
      confirmed: { bg: 'linear-gradient(135deg, #10b981 0%, #059669 100%)', text: 'white', border: '#10b981', icon: '✅' },
      pending: { bg: 'linear-gradient(135deg, #f59e0b 0%, #d97706 100%)', text: 'white', border: '#f59e0b', icon: '⏳' },
      cancelled: { bg: 'linear-gradient(135deg, #ef4444 0%, #dc2626 100%)', text: 'white', border: '#ef4444', icon: '❌' },
    };
              ...
              {[
                ...
                <button
                  ...
                  style={{
                    ...
                    background: filter === btn.value ? 'linear-gradient(135deg, #0066cc 0%, #00b4d8 100%)' : 'white',
                  ...
                  >
                    ...
                    <div style={{
                      ...
                      <span style={{ fontWeight: '600', fontSize: '0.9rem' }}>
                        {statusColor.icon} {apt.status.charAt(0).toUpperCase() + apt.status.slice(1)}
                      </span>
                      ...
                      <div style={{
                        ...
                        <div style={{
                          ...
                          <div>
                            ...
                            <p style={{ margin: '0.2rem 0', fontWeight: '600', color: '#1f2937' }}>
