						...
						<div
							...
							{success && (
								<div
									...
									<strong>✓ Success!</strong> We've received your message and
					...
					<div
						...
						{[
							...
							},
							{
								...
								answer:
									"Yes! We offer a complimentary initial consultation to discuss your needs and how we can help.",
							},
							{
								question: "What services do you specialize in?",
								answer:
									"We provide strategic planning, digital transformation, market analysis, organizational design, and change management services.",
							},
							{
								question: "Can you work with businesses of all sizes?",
								answer:
									"Absolutely! We have experience working with startups, SMEs, and large enterprises across various industries.",
							},
						].map((item, idx) => (
							<div
								key={idx}
			...
			<section
				...
				<div className="container">
					...
					<p
						...
						Follow us on social media and stay updated with the latest insights
						and updates from PositiveHills
					</p>
					<div
						style={{
							display: "flex",
