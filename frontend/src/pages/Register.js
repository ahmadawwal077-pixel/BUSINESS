      ...
      >
        ...
        >
          ...
          <p style={{ color: '#6b7280', marginBottom: '2rem', fontSize: '0.95rem' }}>
            Check your inbox (and spam folder) for a verification link. Click the link to activate your account.
          </p>
      ...
      <div style={{
        ...
        <div style={{
          ...
          <div style={{
            ...
            <h1 style={{ margin: '0 0 0.5rem 0', fontSize: '2rem', fontWeight: 'bold' }}>Create Account</h1>
            <p style={{ margin: 0, opacity: 0.95, fontSize: '0.95rem' }}>Join our community today</p>
          </div>
          ...
          <div style={{ padding: '3rem 2rem' }}>
            ...
            <form onSubmit={handleSubmit}>
              ...
              <div style={{
                ...
                <span style={{ padding: '0 1rem' }}>Already have an account?</span>
                <div style={{ flex: 1, height: '1px', background: '#e5e7eb' }} />
              </div>
