...
const ScheduleConsultationPopup = ({ isOpen, onClose }) => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const API_URL = 'http://localhost:5000/api/consultations/submit';
    ...
    return (
      <div style={{
        ...
        <div style={{
          ...
          <div style={{ fontSize: '60px', marginBottom: '20px', animation: 'scaleIn 0.5s ease-out' }}>✓</div>
          <h2 style={{ color: '#1f2937', marginBottom: '10px', fontSize: '24px', fontWeight: '700' }}>Success!</h2>
  ...
  return (
    <div style={{
      ...
      <div className="form-container" style={{
        ...
        {/* Header */}
        <div style={{
          background: 'linear-gradient(135deg, #0066cc 0%, #0052a3 50%, #00b4d8 100%)',
          color: 'white',
          padding: '40px 30px',
          display: 'flex',
          ...
          <div style={{ display: 'flex', gap: '12px' }}>
            <button
              ...
              style={{
                ...
                gap: '8px',
                letterSpacing: '0.3px',
                boxShadow: loading ? 'none' : '0 4px 15px rgba(0, 102, 204, 0.3)',
              }}
              onMouseEnter={(e) => {
                if (!loading) {
                  e.currentTarget.style.transform = 'translateY(-2px)';
                  e.currentTarget.style.boxShadow = '0 8px 25px rgba(0, 102, 204, 0.4)';
                }
              }}
              onMouseLeave={(e) => {
